...
export class AppViewModel extends observable.Observable {
    ...
    private loadData(): void {
        ...
        this._examples.push({ Id: "65", title: "RadAutoCompleteTextView(Beta)", group: "controls", description: "Telerik AutoComplete for NativeScript", isControl: true, moduleName: "" });
