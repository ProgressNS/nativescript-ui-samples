...
export class ChampionsLeagueModel extends Observable {
    ...
    constructor() {
        ...
        var stat6 = new ChampionsLeagueStat("2013-2014", "Real Madrid", "Atlético Madrid", "Christiano Ronaldo (17)\nZlatan Ibrahimović (10)\nDiego Costa (8)");
        var stat7 = new ChampionsLeagueStat("2014-2015", "Barcelona", "Juventus", "Neymar (10)\nCristiano Ronaldo (10)\nLionel Messi (10)");
        var stat8 = new ChampionsLeagueStat("2015-2016", "Real Madrid", "Atlético Madrid", "Christiano Ronaldo (16)\nRobert Lewandowski (9)\nLuis Suárez (8)");
        var stat9 = new ChampionsLeagueStat("2016-2017", "Real Madrid", "Juventus", "Christiano Ronaldo (12)\nLionel Messi (9)\nEdinson Cavani (8)");
