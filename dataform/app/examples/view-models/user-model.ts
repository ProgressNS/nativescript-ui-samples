export class UserViewModel {
    ...
    get superUser() {
        if (!this._superUser) {
            this._superUser = new SuperUser("John", "Doe", "john_doe", "jdpass", "jd@company.com", "2000-08-15", "male", "Company Inc.", "www.company.com", "555-5325", "Gargantua", "Metropolis", "South Street", 1, 11111, "None");
        }
