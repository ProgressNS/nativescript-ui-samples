...
describe("Calendar", () => {
    ...
    const stylingText = "Calendar styling";
    const eventViewModesText = "Events view modes";
    const dayViewText = "Calendar day view";
    ...
    describe(stylingText, () => {
        it("should open Calendar styling view", async () => {
            await navigateBackToHome(driver);
            await scrollToElement(driver, stylingText);
    ...
    describe(eventViewModesText, () => {
        it("should open a day with two events", async () => {
            ...
            const twelfthDay = await driver.findElementByText("12");
            await twelfthDay.click();
            const firstEvent = await driver.findElementByText("Very important meeting");
            expect(firstEvent).to.exist;
            const secondEvent = await driver.findElementByText("Another meeting");
            expect(secondEvent).to.exist;
        });
    });
